...
class Solution2 {
    ...
    public int rob(TreeNode root) {
        ...
        // maxMoney[0] = maximum money if current node is skipped
        // maxMoney[1] = maximum money from subtree regardless of current node
    ...
    private int[] recursion(TreeNode root) {
        ...
        //
        // Since current node is skipped,
        // each child may either be robbed or skipped.
        int skipCurrent = left[1] + right[1];
        ...
        return new int[] {
            skipCurrent,
            Math.max(skipCurrent, robCurrent)
        };
    }
}